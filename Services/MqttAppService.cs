...
using ClientDotNet.Interfaces;
using System;
using System.Threading.Tasks;
using MQTTnet.Protocol;


namespace ClientDotNet.Services
{
    /// <summary>
    ...
    public class MqttAppService : IMqttAppService
    {
        ...
        public MqttAppService(IMqttClient mqttClient)
        {
        ...
        public async Task<MqttClientPublishResult> PublishAsync(string topic, string payload)
        {
            ...
            var message = new MqttApplicationMessageBuilder()
                ...
                .WithQualityOfServiceLevel(MqttQualityOfServiceLevel.ExactlyOnce) // Using QoS level 2 (Exactly once) for message delivery guarantee.
                .Build();
        ...
        public async Task SubscribeAsync(string topic, Func<MqttApplicationMessageReceivedEventArgs, Task> handler)
        {
            ...
            //_mqttClient.ApplicationMessageReceivedAsync(e => handler(e));
